    ...
    class OpcManager
    {
        ...
        private OpcManager()
        {
            ...
            try
            {
                ...
                Module1._OPCGroup.OPCItems.AddItems(Module1.TagCount, Module1.GetTagNameList(), Module1.GetHandleList(), out Module1.ItemServerHandles, out Module1.ItemServerErrors);
                bool itemgood = false;
